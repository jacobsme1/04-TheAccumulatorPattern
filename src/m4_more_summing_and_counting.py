...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(0, 9, 0.59)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 0
    answer = count_cosines_from(3, 6, .99)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 7
    answer = count_cosines_from(4, 18, 0.11)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(0, 5, 0.2)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(89, 95, 0.33)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.592857  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 7)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.787872  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(8, 16)
