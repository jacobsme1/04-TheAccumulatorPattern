...
#             It loops within the range r but it is void of the variable k to use within the loop
#
...
#        and one is WRONG.  Which is the WRONG one? the second one is the wrong one
#
#              x = starting_point.x
#              for k in range(n):
