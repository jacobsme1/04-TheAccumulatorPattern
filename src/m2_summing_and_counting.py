...
def run_test_sum_more_cosines():
    ...
    if answer is not None:
        ...
        # Test 3:
    expected = -0.41302  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(0, 11)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 2:
    expected = 181
    answer = count_sines_vs_cosines(180)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
